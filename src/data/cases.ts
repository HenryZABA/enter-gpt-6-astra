...
/**
 * The 14 completed GPT-6 Astra cases. Single source of truth for the whole page:
 * counts, filters, search and the prompt bundle are all derived from this array.
 */
