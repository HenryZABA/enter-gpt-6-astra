    ...
    <article
      ...
      <div className="relative overflow-hidden border-b border-border/70">
        ...
        {selectionMode && (
          <Checkbox
            ...
            aria-label={t("card.selectPrompt", { title })}
      ...
      <div className="flex flex-1 flex-col p-4">
        <button
          ...
          className="text-left"
        >
          <h3 className="font-display text-base font-semibold leading-snug tracking-[-0.015em] text-foreground transition-colors group-hover:text-primary-foreground">
            {title}
          </h3>
        </button>
